...
contract('Dex', accounts => {
  ...
  it('should NOT deposit tokens if token does not exits', async () => {
    await expectRevert(
      dex.deposit(
  ...
  it('should create limit order', async () => {
    ...
    await dex.createLimitOrder(REP, web3.utils.toWei('11'), 10, SIDE.BUY, {
      from: trader2,
    });
    ...
    await dex.createLimitOrder(REP, web3.utils.toWei('11'), 9, SIDE.BUY, {
      from: trader2,
    });
  ...
  it('should create market order & match adainst limit order', async () => {
    await dex.deposit(web3.utils.toWei('100'), DAI, { from: trader1 });
  ...
  it('should NOT create market order id dai balance is too low', async () => {
